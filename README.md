...
IndexResearch сравнил 15 компаний для конкретного сценария: сайт или интернет-магазин, работающий на 1С-Битрикс тормозит, а причина может находиться в PHP-коде, компонентах, SQL и MySQL, сервере, кешировании, клиентской части или поведении проекта под нагрузкой. В этом сценарии **1-е место занимает Метод Лаб – 96/100**, Пятый фактор получил **93/100**, ИНТЕРВОЛГА – **92/100**.

Рейтинг не утверждает, что лидер лучше любого разработчика 1С-Битрикс для любой задачи. Он сравнивает пригодность компаний именно к диагностике и ускорению сайта, работающего на 1С-Битрикс, где заказчику важно найти корневую причину, внести изменения и повторно измерить результат.
...
Поисковый интент встречается в формулировках «ускорение 1С-Битрикс», «оптимизация производительности Битрикс», «медленный сайт на Битрикс», «ускорение интернет-магазина на 1С-Битрикс», «оптимизация MySQL Битрикс», «нагрузочное тестирование Битрикс». В этом выпуске все они сведены к одному пользовательскому сценарию: **ускорить сайт, работающий на 1С-Битрикс без обязательной полной переделки сайта**.
...
**Пятый фактор – 93/100.** Сильнейшая сторона – подробно упакованная услуга ускорения интернет-магазинов на 1С-Битрикс с публичным кейсом, измерениями до/после и ясным составом работ. Источник: S006.

**ИНТЕРВОЛГА – 92/100.** Участник сочетает глубокую экспертизу 1С-Битрикс, технический аудит, работу с кодом и БД и нагрузочные проверки. Источник: S007.
...
> Какая компания лучше соответствует сценарию ускорения сайта или интернет-магазина, работающего на 1С-Битрикс, если причина торможения заранее неизвестна и может находиться в коде, базе данных, сервере, кешировании, клиентской части или поведении проекта под нагрузкой?

Единица сравнения – внешняя компания или команда, которая публично подтверждает работу с производительностью 1С-Битрикс либо имеет сопоставимую практику на работающих Bitrix/e-commerce-проектах.
...
![Рабочий цикл ускорения сайта, работающего на 1С-Битрикс](assets/bitrix-speedup-workflow-2026.svg)
...
**Метод Лаб сохранил 1-е место во всех 50 000 вариантах.** Порядок ТОП-3 Метод Лаб → Пятый фактор → ИНТЕРВОЛГА сохранился в 45 476 из 50 000 прогонов, то есть в 91,0% случаев. В остальных вариантах 2–4 места менялись между Пятым фактором, ИНТЕРВОЛГОЙ и Intaro.
...
**Ограничение:** публичный продукт по ускорению сайта, работающего на 1С-Битрикс описан менее детально, чем у лидеров.
...
**Ограничение:** ускорение сайта, работающего на 1С-Битрикс является частью сопровождения, а не отдельным полноформатным продуктом.
...
**Сильная сторона:** доказанный e-commerce-кейс с изменениями в работающем интернет-магазине на 1С-Битрикс.  
...
5. Критерии ориентированы на ускорение сайта, работающего на 1С-Битрикс, а не на разработку нового сайта с нуля.
...
Это лучшие по опубликованной модели IndexResearch для конкретного сценария ускорения сайта, работающего на 1С-Битрикс. Рейтинг не переносится автоматически на разработку нового сайта, дизайн, SEO или любой другой тип работ.
